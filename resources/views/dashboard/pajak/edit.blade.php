    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div
                ...
                <h1 class="h2">EDIT DATA PAJAK</h1>
            </div>

            <form method="post" action="/dash/pajaks/{{ $pajak->id }}" enctype="multipart/form-data">
                @method('put')
                @csrf
                ...
                <div class="mb-3 row">
                    <div class="col-lg-4">
                        ...
                        <input required autofocus type="text" class="form-control @error('NOP') is-invalid @enderror"
                            id="NOP" name="NOP" placeholder="cth: 12345" value="{{ old('NOP', $pajak->NOP) }}">
                    ...
                    <div class="col-lg-8">
                        ...
                        <input required type="text" class="form-control @error('nama') is-invalid @enderror"
                            id="nama" name="nama" placeholder="cth: Jhony" value="{{ old('nama', $pajak->nama) }}">
                ...
                <div class="mb-3 row">
                    <div class="col-lg-4">
                        ...
                        <input required type="text"
                            ...
                            name="yang_harus_dibayar" placeholder="cth: 100"
                            value="{{ old('yang_harus_dibayar', $pajak->yang_harus_dibayar) }}">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input required type="text" class="form-control @error('tahun') is-invalid @enderror"
                            id="tahun" name="tahun" placeholder="cth: 2020" value="{{ old('tahun', $pajak->tahun) }}">
        ...
        <div class="mb-3 row">
            <div class="col-lg-4">
                ...
                <select class="form-select" id="select_dua" name="pemilik_id" required>
                    @foreach ($pemiliks as $pem)
                        @if (old('pemilik_id', $pajak->pemilik_id) == $pem->id)
