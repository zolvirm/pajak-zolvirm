                    ...
                    <tbody>
                        @if ($trashs->count())
                            @foreach ($trashs as $index => $item)
                                <tr>
                                    <td class="text-center">{{ $index + $trashs->firstItem() }}</td>
                                    <td>{{ $item->NOP }}</td>
                                    <td>{{ $item->nama }}</td>
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center">
                                            <div class="d-inline">
                                                <a href="/dash/restore-pajak/{{ $item->id }}"
                                            ...
                                            &nbsp;
                                            <form action="/dash/forcedelete-pajak/{{ $item->id }}" method="post"
                                                class="d-inline">
                                                @csrf
